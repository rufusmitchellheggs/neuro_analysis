...
|Animal|Session|Stage|Neuron|Place Cell Status|Place Cell Centre|Place Cell Centre Event count|Rewarded Well|Euclidean Distance from SW1|Euclidean Distance from SW2|Euclidean Distance from SW3|Mutual_Information|Percentile|Distribution|
|------|-------|-----|------|-----------------|-----------------|-----------------------------|-------------|---------------------------|---------------------------|---------------------------|------------------|----------|------------|
